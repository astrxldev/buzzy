  ...
  return (
    <div className="flex w-full justify-center">
      <div className="mx-auto flex min-h-dvh w-full max-w-6xl flex-col">
        ...
        <div className="my-10 flex flex-wrap justify-evenly gap-5">
          <HomeLink
        ...
        <footer className="flex h-full flex-col justify-end pb-3 text-muted-foreground md:justify-center">
          <div className="flex flex-col justify-between gap-2 text-center sm:flex-row sm:text-left">
            ...
            <div className="flex justify-center gap-2 sm:justify-start">
              ...
              >
                <svg
                  ...
                  width={24}
                  height={24}
                  className="mx-auto h-5 w-6 fill-current hover:fill-white"
                >
                  <title>Gitea</title>
                  <g>
                    <path
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                  className="mx-auto w-5 fill-current hover:fill-white"
                >
                  <title>Discord</title>
  ...
  return (
    <SimpleTooltip text={desc}>
      <Link
        href={href}
        className={cn(
          "flex flex-col p-8 text-center md:p-10",
